...
class DDPM(Scene):
    def construct(self):
        ...
        logo = Text("JAYANDJEAN", fill_color="#ece6e2").next_to(title, DOWN, buff=0.5).scale(1.2)
        ...
        mid = ImageMobject("assets/mid.jpg").set_height(2)
        sd3 = ImageMobject("assets/sd3.png").set_height(2)
        flux = ImageMobject("assets/flux.png").set_height(2)
        ...
        image_prompt = ImageMobject("assets/prompt.png").set_width(4.2)
